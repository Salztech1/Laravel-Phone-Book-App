...
<div style="background-color: #F5F5F5; border: 1px solid #F5F5F5; height: 821px; " class="mt-5 ">
    <div class="contact">
        ...
        <input type="text" name="lastName" placeholder="Email" class="w-50" style="padding: 15px 10px; border:none; background-color:#CCCCCC;border-radius: 5px; margin-left:10px; margin-top:15px; outline:none; " />
        </div>

        <img src="{{URL('images/category.png')}}">
        <input type="text" name="lastName" placeholder="Category" class="w-50" style="padding: 15px 10px; border:none; background-color:#CCCCCC;border-radius: 5px; margin-left:10px; margin-top:15px; outline:none; " />
        </div>
